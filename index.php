...
<body>
	...
	<div class="wrap">
		...
		<div class="header">
			...
			<div id="heading">
				<a href="index.php"><h2>Online Railway Ticket Reservation System</h2></a>
			</div>
			</div>
		</div>
		...
		<div class="span12 well">
			...
			<div id="myCarousel" class="carousel slide" style="width:600px; float:left;margin-bottom:3px;">		
				...
				<div class="item"><img src="images/a9.jpg" style="width:600px;height:350px;"/></div>
				<div class="item"><img src="images/1.jpg" style="width:600px;height:350px;"/> </div>
				<div class="item"><img src="images/a12.jpg"style="width:600px;height:350px;"/></div>
...
<footer >
		<div style="width:100%;">
			...
			<p class="text-right text-info">	Desinged By : Simanta</p>
			</div>
		</div>
		</footer>	</div>
